...
{
    public class PhraseDxOptionsModelBinderProvider :
        BaseModelBinderProvider<PhraseDxOptionsViewModel, PhraseDxOptionsBinder>
    {
    }
    
    public class PatientDxOptionsModelBinderProvider :
        BaseModelBinderProvider<PatientDxOptionsViewModel, PatientDxOptionsBinder>
    {
    }

    public class DocumentDxOptionsModelBinderProvider :
    BaseModelBinderProvider<DocumentDxOptionsViewModel, DocumentDxOptionsBinder>
    {
    }
