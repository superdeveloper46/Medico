...
export class MedicationManagementComponent {
  ...
  @ViewChild('medicationUpdateDataGrid', { static: false })
  medicationUpdateDataGrid!: DxDataGridComponent;
  @ViewChild('medicationUpdatePopup', { static: false })
  medicationUpdatePopup!: DxPopupComponent;
  @ViewChild('medicationsExcelFileUploader', { static: false })
  medicationsExcelFileUploader!: DxFileUploaderComponent;
  ...
  downloadExcelMedicationsFile($event: Event, fileName: string) {
    ...
    this.medicationUpdateService
      .downloadMedicationsExcelFile(fileName)
      .then(blob => {
  ...
  createUpdateMedicationUpdate() {
    ...
    this.medicationUpdateService
      .scheduleMedicationsUpdate(medicationsFile)
      .then(() => {
