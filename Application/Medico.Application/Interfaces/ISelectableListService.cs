...
namespace Medico.Application.Interfaces
{
    public interface ISelectableListService
    {
        ...
        Task<IEnumerable<Docs>> GetDocList();
        Task<IEnumerable<Docs>> GetMessageStatusList();
        Task<IEnumerable<Docs>> GetCategoryList();
        Task<IEnumerable<TemplateWithTypeNameViewModel>> GetProcedureList(Guid companyId);
        Task<IEnumerable<Docs>> GetDiagnosisList();
        Task<IEnumerable<Docs>> GetMessageTypeList();
        Task<IEnumerable<Docs>> GetMessageSubjectList();
        Task<IEnumerable<Docs>> GetSubTaskTitleList();
        Task<IEnumerable<Docs>> GetErrorLogStatusList();
    }
}