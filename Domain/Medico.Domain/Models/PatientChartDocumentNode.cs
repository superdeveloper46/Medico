...
namespace Medico.Domain.Models
{
    ...
    {
        public PatientChartDocumentNode()
        {
            PatientChartDocumentAppointments =
                new List<AppointmentPatientChartDocument>();
        }
        ...
        public List<AppointmentPatientChartDocument> PatientChartDocumentAppointments { get; }
    }
}