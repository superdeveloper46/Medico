...
namespace Medico.Application.SelectableItemsManagement
{
    public interface ISelectableItemsService
    {
        ...
        VariablesUniquenessCheckResultVm CheckNonUniqueSelectableVariablesInHtmlContent(string htmlContent);

        string WrapAllSelectableListValuesToBoldTag(string detailedTemplateContent);
    }
}