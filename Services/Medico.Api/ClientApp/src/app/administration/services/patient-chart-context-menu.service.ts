...
export class PatientChartContextMenuService {
  getContextMenuItemsBasedOnPatientChartNode(
    ...
    const patientChartContextMenuActionItems = new PatientChartContextMenuActionItems(
    ...
    switch (itemType) {
      ...
      case PatientChartNodeType.DocumentNode:
        return this.getDocumentNodeMenuItems(
          patientChartContextMenuActionItems,
          isCopiedPatientChartNodeExist
        );

      case PatientChartNodeType.SectionNode:
        return this.getSectionNodeMenuItems(
          patientChartContextMenuActionItems,
          isCopiedPatientChartNodeExist
        );
      ...
      case PatientChartNodeType.ProblemListNode:
        return this.getCustomNodeMenuItems(patientChartContextMenuActionItems);
    }
  }

  private getSectionNodeMenuItems(
    patientChartContextMenuActionItems: PatientChartContextMenuActionItems,
    isCopiedPatientChartNodeExist: boolean
  ): PatientChartContextMenuAction[] {
    const menuItems = [
  ...
  private getTemplateNodeMenuItems(
    patientChartContextMenuActionItems: PatientChartContextMenuActionItems
  ): PatientChartContextMenuAction[] {
    return [
  ...
  private getTemplateListNodeMenuItems(
    patientChartContextMenuActionItems: PatientChartContextMenuActionItems
  ): PatientChartContextMenuAction[] {
    return [
  ...
  private getRootNodeMenuItems(
    patientChartContextMenuActionItems: PatientChartContextMenuActionItems
  ): PatientChartContextMenuAction[] {
    return [patientChartContextMenuActionItems.newDocumentNode];
  }

  private getDocumentNodeMenuItems(
    patientChartContextMenuActionItems: PatientChartContextMenuActionItems,
    isCopiedPatientChartNodeExist: boolean
  ): PatientChartContextMenuAction[] {
    const menuItems = [
